    ...
    myEcharts() {
      ...
      this.timer = setInterval(function () {
        ...
        that.$axios
          ...
          .get(
            "http://121.199.73.186:8080/sensorData/toGet/" + that.sid + "/co2"
          )
          .then((res) => {
            // console.log("--------------res!-----------");
            // console.log(res);
            ...
            that.data1.name = new Date(
              res.data.data.captureDateTime
            ).toString();
            that.data1.value = [
      ...
      function finale() {
        ...
        return {
          ...
          value: [that.data1.value[0], that.data1.value[1]],
        };
      }
      function randomData() {
